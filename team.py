    ...
    "team_members": [
        {
            ...
            "student_id": "1341857",
            "email": "thannguyen@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Jenny Mai",
            "student_id": "1538060",
            "email": "jenny.mai@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
